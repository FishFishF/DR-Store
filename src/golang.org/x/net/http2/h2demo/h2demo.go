...
<body>
<h1>Go + HTTP/2</h1>
<p>Welcome to <a href="https://golang.org/">the Go language</a>'s <a href="https://http2.github.io/">HTTP/2</a> runtime & interop server.</p>
...
href="https://http2.github.io/">HTTP/2</a> runtime & interop server.</p>
...
<hr><a href='/'>&lt;&lt Back to Go HTTP/2 runtime server</a></body></html>`)
	})
}
